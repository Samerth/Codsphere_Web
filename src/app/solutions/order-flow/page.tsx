        ...
        <div className="container-wrapper">
          <div className="max-w-3xl">
            ...
            <h1 className="text-white text-4xl sm:text-5xl font-bold leading-tight mb-6">
              See what is stuck before it becomes late.
            </h1>
            <p className="text-white/70 text-xl leading-relaxed mb-8">
              Give every order one visible timeline. See what is in design, waiting for approval, 
              in production and ready to ship—with alerts when something stalls.
            </p>
