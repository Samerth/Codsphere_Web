        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
            ...
            <p className="hero-description text-white/70 text-base lg:text-lg max-w-md leading-relaxed">
              harness the power of the sun with our expert solar solutions for sustainable energy
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="content-text lg:w-1/2">
              <p className="text-white text-lg lg:text-xl leading-relaxed font-medium">
                Ready to reduce your carbon footprint and energy costs? Looking for a reliable
                partner for solar installation? We provide comprehensive solar solutions from
              ...
              <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 w-full">
                <div className="max-w-md bg-white/95 backdrop-blur-sm rounded-[30px] p-8 lg:p-12">
                  ...
                  <p className="text-[#1a2634]/70 text-base lg:text-lg leading-relaxed mb-8">
                    As your solar energy partner, we provide everything you need for a successful
                    transition to renewable energy. From initial assessment to final installation,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                image:
                  "https://images.unsplash.com/photo-1559302504-64aae6ca6b6d?q=80&w=2074&auto=format&fit=crop",
              },
              {
                ...
                image:
                  "https://images.unsplash.com/photo-1558449028-b53a39d100fc?q=80&w=2074&auto=format&fit=crop",
              },
            ].map((service, i) => (
      ...
      <section className="bg-[#1a2634] py-16 lg:py-24 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-white/50 text-base lg:text-lg max-w-2xl mx-auto mb-10">
            Contact us today for a free solar assessment and quote. Our team of experts will help
            you find the perfect solar solution for your property.
          </p>
          <Link
            href="/aqua-fix/contact"
