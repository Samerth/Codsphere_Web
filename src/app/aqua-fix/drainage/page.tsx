        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
            ...
            <p className="hero-description text-white/70 text-base lg:text-lg max-w-md leading-relaxed">
              professional drainage solutions to keep your pipes flowing freely. Fast response,
              lasting results.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="content-text lg:w-1/2">
              <p className="text-white text-lg lg:text-xl leading-relaxed font-medium">
                Blocked drains causing problems? Slow drainage or unpleasant odors? Our expert team
                uses the latest technology to diagnose and resolve all drainage issues quickly and
                efficiently, minimizing disruption to your property.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 w-full">
                <div className="max-w-md bg-white/95 backdrop-blur-sm rounded-[30px] p-8 lg:p-12">
                  ...
                  <p className="text-[#1a2634]/70 text-base lg:text-lg leading-relaxed mb-8">
                    From simple blockages to complex sewer repairs, we have the expertise and
                    equipment to handle any drainage challenge. Fast response times guaranteed.
                  </p>
                  <Link
                    href="/aqua-fix/contact"
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/70">
                Blocked drains don't wait for business hours. Neither do we.
              </p>
            </div>
            <a
              href=""
