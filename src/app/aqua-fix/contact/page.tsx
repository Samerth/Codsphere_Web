        ...
        ctx = gsap.context(() => {
          ...
          gsap.fromTo(
            ...
            { opacity: 0, x: -40 },
            {
              ...
              stagger: 0.1,
              ease: "power3.out",
              scrollTrigger: { trigger: ".contact-info-section", start: "top 80%" },
            },
          );
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
            ...
            <p className="hero-description text-white/70 text-base lg:text-lg max-w-md leading-relaxed">
              get in touch with our team for all your plumbing, heating, drainage, and solar needs.
              We're here to help.
            </p>
          </div>
        </div>
              ...
              <div className="mt-12 pt-8 border-t border-white/10">
                ...
                <div className="flex gap-4">
                  {["facebook", "instagram", "linkedin"].map((social) => (
                    ...
                    >
                      <span className="text-white text-xs uppercase">{social[0]}</span>
                    </a>
                  ))}
                </div>
              </div>
              ...
              <div className="contact-form bg-white rounded-[30px] p-8 lg:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="name" className="block text-[#1a2634]/60 text-sm mb-2">
                        Your Name *
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label htmlFor="email" className="block text-[#1a2634]/60 text-sm mb-2">
                        Your Email *
                      </label>
                      <input
                        type="email"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="phone" className="block text-[#1a2634]/60 text-sm mb-2">
                        Phone Number
                      </label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label htmlFor="service" className="block text-[#1a2634]/60 text-sm mb-2">
                        Service Required
                      </label>
                      <select
                        id="service"
                  ...
                  {/* Message */}
                  <div>
                    <label htmlFor="message" className="block text-[#1a2634]/60 text-sm mb-2">
                      Your Message *
                    </label>
                    <textarea
                      id="message"
