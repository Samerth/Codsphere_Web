...
function MobileMenuButton() {
  ...
  const navLinks = [
    { href: "/aqua-fix/sanitary", label: "sanitary" },
    { href: "/aqua-fix/services#heating", label: "heating" },
    { href: "/aqua-fix/services#drainage", label: "drainage" },
    { href: "/aqua-fix/solar", label: "solar" },
    { href: "/aqua-fix/references", label: "references" },
    { href: "/aqua-fix/home#team", label: "team" },
  ];
...
export default function SanitaryPage() {
        ...
        ctx = gsap.context(() => {
          ...
          gsap.fromTo(
            ...
            { opacity: 0, x: -60 },
            {
              ...
              duration: 0.8,
              ease: "power3.out",
              scrollTrigger: { trigger: ".content-section", start: "top 70%" },
            },
          );
  ...
  return (
    <div ref={pageRef} className="bg-[#1a2634] min-h-screen">
          ...
          <div className="absolute inset-0 flex">
            {heroImages.map((image, i) => (
              <div key={i} className="flex-1 relative overflow-hidden">
                <img src={image} alt={`Bathroom ${i + 1}`} className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
            ...
            <p className="hero-description text-white/70 text-base lg:text-lg max-w-md leading-relaxed">
              we are a certified company & provide best plumbing services for you & your company.
            </p>
      ...
      <section id="content" className="content-section bg-[#1a2634] py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="content-text lg:w-1/2">
              <p className="text-white text-lg lg:text-xl leading-relaxed font-medium">
                Would you like a new bathroom? Or would you like to carry out a long-overdue
                modernization? In us you will find a competent and reliable partner.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="space-y-0">
            {features.map((feature, i) => (
              <div key={i} className="feature-item py-6 border-b border-white/10 first:border-t">
                <div className="flex items-center gap-4">
                  <span className="w-2 h-2 bg-white rounded-full flex-shrink-0" />
                  <p className="text-white text-lg lg:text-2xl font-medium">{feature}</p>
                </div>
              </div>
            ))}
          </div>
              ...
              <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 w-full">
                <div className="max-w-md">
                  ...
                  <p className="text-[#1a2634]/70 text-base lg:text-lg leading-relaxed mb-8">
                    As your plumbing company, we have all the important information for your
                    remodeled bathroom. From planning to execution, we're with you every step.
                  </p>
                  <Link
                    href="/aqua-fix/contact"
            ...
            {[
              {
                ...
                description: "Custom bathroom layouts tailored to your space and lifestyle needs.",
                image:
                  "https://images.unsplash.com/photo-1620626011761-996317b8d101?q=80&w=2069&auto=format&fit=crop",
              },
              {
                title: "Fixture Installation",
                description: "Professional installation of sinks, toilets, showers, and bathtubs.",
                image:
                  "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=2070&auto=format&fit=crop",
              },
              {
                title: "Pipe & Drainage",
                description: "Complete plumbing solutions for new builds and renovations.",
                image:
