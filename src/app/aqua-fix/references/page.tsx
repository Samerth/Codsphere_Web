...
function CategoryCarousel({ images, category }: CarouselProps) {
  ...
  const prevSlide = () => {
    ...
    setIsAnimating(true);
    setCurrentIndex(
      (prev) => (prev - 1 + Math.max(1, images.length - 2)) % Math.max(1, images.length - 2),
    );
    setTimeout(() => setIsAnimating(false), 500);
  };
      ...
      try {
        ...
        ctx = gsap.context(() => {
          ...
          gsap.fromTo(
            ...
            { opacity: 1, scale: 1, duration: 1, ease: "power3.out", stagger: 0.1 },
          );
      ...
      <section className="categories-section bg-[#1a2634] py-8 lg:py-16">
        <div className="max-w-[1600px] mx-auto px-4 lg:px-8">
          ...
          <div className="mb-16 lg:mb-24">
            <CategoryCarousel images={sanitaryImages} category="SANITARY" />
          </div>
          ...
          {/* Drainage Carousel */}
          <div className="mb-8">
            <CategoryCarousel images={drainageImages} category="DRAINAGE" />
          </div>
        </div>
      </section>
              ...
              <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 w-full">
                <div className="max-w-lg">
                  ...
                  <p className="text-[#1a2634]/70 text-base lg:text-lg leading-relaxed mb-8">
                    We are the professionals when it comes to plumbing systems. Our competent
                    employees install complete systems quickly and reliably. With us you can trust
                    in brand quality. Our services for you in the field of plumbing technology:
                  </p>
                  <Link
                    href="/aqua-fix/contact"
