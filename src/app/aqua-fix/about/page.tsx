...
function NavPill() {
  ...
  const navLinks = [
    { href: "/aqua-fix/sanitary", label: "sanitary" },
    { href: "/aqua-fix/heating", label: "heating" },
    { href: "/aqua-fix/drainage", label: "drainage" },
    { href: "/aqua-fix/solar", label: "solar" },
    { href: "/aqua-fix/references", label: "references" },
    { href: "/aqua-fix/home#team", label: "team" },
  ];
        ...
        >
          ...
          <span
            className={`relative z-10 transition-colors duration-200 ${
              hoveredLink === link.href ? "text-white" : "text-[#1e2a36]/70"
            }`}
          >
            {link.label}
          </span>
...
function StatCounter({
  ...
  return (
    <div className="stat-item text-center">
      ...
      <div className="text-white/40 text-xs uppercase tracking-[0.25em]">{label}</div>
    </div>
  );
}
...
const timeline = [
  ...
  },
  {
    ...
    description: "Added heating and drainage services to meet growing customer demand.",
  },
  {
    year: "2020",
    title: "Green Initiative",
    description: "Launched our solar and sustainable energy division for eco-conscious customers.",
  },
  {
    year: "2023",
    title: "500+ Projects",
    description: "Reached milestone of completing over 500 successful projects across Vancouver.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
            ...
            <p className="hero-description text-white/70 text-base lg:text-lg max-w-md leading-relaxed">
              since 2015, we've been Vancouver's trusted partner for plumbing, heating, drainage,
              and solar solutions.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="story-content lg:w-1/2">
              ...
              <p className="text-white/70 text-base lg:text-lg leading-relaxed mb-6">
                AquaFix was founded in 2015 with a simple mission: to provide Vancouver homeowners
                and businesses with reliable, high-quality plumbing services they can trust.
              </p>
              <p className="text-white/70 text-base lg:text-lg leading-relaxed mb-6">
                What started as a small team of dedicated plumbers has grown into a full-service
                company offering sanitary, heating, drainage, and solar solutions. Our growth is
                built on a foundation of exceptional workmanship and customer satisfaction.
              </p>
              <p className="text-white/70 text-base lg:text-lg leading-relaxed">
                Today, we're proud to serve hundreds of clients across Vancouver, maintaining the
                same commitment to quality and service that defined us from day one.
              </p>
            </div>
          </div>
        </div>
                    ...
                    {team.map((member, i) => (
                      <img
                        ...
                        className={`w-full h-[450px] object-cover transition-opacity duration-500 ${
                          hoveredTeamMember === i ? "opacity-100" : "opacity-0 absolute inset-0"
                        }`}
                      />
                    ))}
                  </div>
              ...
              <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 w-full">
                <div className="max-w-md">
                  ...
                  <p className="text-[#1a2634]/70 text-base lg:text-lg leading-relaxed mb-8">
                    Join hundreds of satisfied customers who trust AquaFix for all their plumbing,
                    heating, drainage, and solar needs. Contact us today for a free consultation.
                  </p>
                  <Link
                    href="/aqua-fix/contact"
