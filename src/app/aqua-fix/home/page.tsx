        ...
        ctx = gsap.context(() => {
          ...
          gsap.fromTo(
            ...
            { opacity: 0, y: 40 },
            {
              ...
              duration: 0.8,
              ease: "power3.out",
              scrollTrigger: { trigger: ".references-section", start: "top 70%" },
            },
          );
          ...
          document.querySelectorAll(".left-image, .right-image").forEach((image) => {
            gsap.fromTo(
              image,
              { opacity: 0, y: 60 },
              {
              ...
              <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20 w-full">
                <div className="w-full lg:w-[80%]">
                  <h1 className="hero-title font-['Playfair_Display'] text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.05] mb-8">
                    ...
                    <span className="word inline-block">PLUMBING</span>
                    <br />
                    <span className="word inline-block">SPECIALIST</span>
                    <br />
                    <span className="word inline-block">IN</span>{" "}
                    <span className="word inline-block">VANCOUVER</span>
                  </h1>
                  <p className="hero-description text-white/80 text-base lg:text-lg mb-10 leading-relaxed max-w-md">
                    we are a certified company & provide best plumbing services for you & your
                    company.
                  </p>
            ...
            <div id="learn-more" className="about-section relative">
              <div className="max-w-2xl">
                ...
                <p className="about-text text-white/50 text-base lg:text-lg leading-relaxed mb-8">
                  The company is a master plumbing business founded in 2015 in Vancouver. Our team
                  of certified professionals is specialized in all modern technologies around
                  plumbing, heating, and drainage systems.
                </p>
                <Link
                  href="/aqua-fix/contact"
              ...
              <div key={service.id}>
                ...
                >
                  ...
                  <div className="service-content w-full lg:w-3/5">
                    ...
                    <Link
                      href={`/aqua-fix/services#${service.id}`}
                ...
                {index < services.length - 1 && <div className="h-px bg-white/10" />}
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="flex gap-6 lg:gap-8">
            ...
            <div className="left-column w-1/2 space-y-6 lg:space-y-8">
              {references
                .filter((_, i) => i % 2 === 0)
                .map((image, i) => (
                  <div key={i} className="left-image group cursor-pointer">
            ...
            <div className="right-column w-1/2 space-y-6 lg:space-y-8 pt-32 lg:pt-48">
              {references
                .filter((_, i) => i % 2 === 1)
                .map((image, i) => (
                  <div key={i} className="right-image group cursor-pointer">
                    <div className="relative rounded-[20px] lg:rounded-[30px] overflow-hidden">
                      <img
                        src={image}
                        alt="Reference project"
              ...
              <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 w-full">
                <div className="max-w-md">
                  ...
                  <p className="text-[#1a2634]/70 text-base lg:text-lg leading-relaxed mb-8">
                    Plumbing, Heating & Drainage from Vancouver. With us you get services from one
                    source. Let us prepare your non-binding offer from us.
                  </p>
                  <Link
                    href="/aqua-fix/contact"
                ...
                {testimonials.map((testimonial, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <div className="font-medium text-[#1a2634] text-sm">{testimonial.name}</div>
                        <div className="text-[#1a2634]/40 text-xs">{testimonial.role}</div>
                      </div>
                    </div>
                  </div>
                ))}
