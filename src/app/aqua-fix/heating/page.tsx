...
function NavPill() {
  ...
  const navLinks = [
    ...
    { href: "/aqua-fix/portfolio", label: "references" },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
            ...
            <p className="hero-description text-white/70 text-base lg:text-lg max-w-md leading-relaxed">
              expert heating solutions to keep your home warm and comfortable all year round with
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="content-text lg:w-1/2">
              <p className="text-white text-lg lg:text-xl leading-relaxed font-medium">
                Is your heating system outdated or inefficient? Looking to upgrade to a more
                eco-friendly solution? We provide comprehensive heating services from installation
                to maintenance, ensuring your comfort in every season.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="max-w-7xl mx-auto px-8 lg:px-16 py-16 lg:py-24 w-full">
                <div className="max-w-md bg-white/90 backdrop-blur-sm rounded-[30px] p-8 lg:p-12">
                  ...
                  <p className="text-[#1a2634]/70 text-base lg:text-lg leading-relaxed mb-8">
                    From boiler installations to radiant floor heating, we have the expertise to
                    keep your home warm efficiently. Trust our certified technicians for all your
                    heating needs.
                  </p>
                  <Link
                    href="/aqua-fix/contact"
