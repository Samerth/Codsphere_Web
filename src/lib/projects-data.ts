...
export const projects: Project[] = [
  {
    ...
    content: {
      ...
      outcomes: [
        "Orders arrive with complete specifications and files attached",
        "Production timeline visible to staff and customers",
        "Reduced status inquiry calls",
        "Measurement pending — system in UAT",
      ],
    },
  },
  {
    ...
    content: {
      ...
      solution: "We built voltverashop.com as the commerce frontend, connected to an operations workspace that tracks orders through fulfillment and manages partner relationships. The system calculates settlements based on who was involved in each transaction. Partners can see their activity and pending payouts. Operations staff have visibility into the full order lifecycle.",
      outcomes: [
        "Unified commerce and operations system",
        "Automated settlement calculations for multi-party transactions",
        "Partner visibility into activity and payouts",
        "Order tracking from sale through fulfillment",
        "Measurement pending — operational metrics being collected",
      ],
    },
  },
];
