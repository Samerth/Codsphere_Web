...
export const ContactForm = () => {
  ...
  return (
    <section className="py-16 bg-white">
      <div className="w-full max-w-[1260px] mx-auto px-[90px]">
        {/* Section heading */}
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Name, Email, Purpose on same line */}
            ...
            {/* Attach file and Submit button - Stacked vertically on LEFT */}
