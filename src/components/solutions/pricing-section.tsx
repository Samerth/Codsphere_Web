...
export default function PricingSection() {
  const plans = [
    {
      id: "starter",
      name: "Capture (Starter)",
      price: "99.00",
      badge: "Best Value",
      description: "Solo trades",
      featuresHeading: "Includes:",
      features: ["Trade-ready site", "Service pages & CTAs", "Mobile layout", "Trust blocks"],
    ...
    },
    {
      ...
      featuresHeading: "Plus:",
      features: ["Lead capture", "24/7 routing", "Faster response"],
    ...
    },
    {
      ...
      featuresHeading: "Plus:",
      features: ["CRM", "Job tracking", "Lead → repeat automation"],
