...
const steps = [
  {
    id: 1,
    title: "Slow response",
    description: "Leads go cold on site.",
    icon: "/icons/archery.svg",
  },
  {
    id: 2,
    title: "Bad leads",
    description: "No context to quote.",
    icon: "/icons/shield.svg",
  },
  {
    id: 3,
    title: "Dropped quotes",
    description: "No one owns next step.",
    icon: "/icons/Group.svg",
  },
  {
    id: 4,
    title: "No repeat work",
    description: "Past customers fade.",
      ...
      <div className="container-wrapper py-12 lg:py-16 xl:py-20">
        <div className="text-center w-5/5 lg:w-4/5 mx-auto pb-4">
          ...
          <p className="mt-2 text-[18px] lg:text-[20px] font-light w-full text-gray-200">
            After the enquiry: slow reply, weak qualify, no follow-up, no repeat.
          </p>
        </div>
