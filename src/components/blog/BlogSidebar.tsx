        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5 lg:space-y-[24px]">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <svg className="absolute right-3 md:right-4 top-1/2 -translate-y-1/2 pointer-events-none" width="12" height="8" viewBox="0 0 12 8" fill="none">
          ...
          {selectedFile ? (
            <div className="flex items-center gap-2 bg-white/10 px-3 py-2 rounded-lg">
              ...
              <span className="text-gray-300 font-sequel text-[13px] md:text-[14px] truncate flex-1">{selectedFile.name}</span>
              <button type="button" onClick={removeFile} className="text-red-400 hover:text-red-300" disabled={formStatus.type === 'loading'}>
            ...
            <div onClick={triggerFileInput} className="flex items-center gap-2 lg:gap-[10px] cursor-pointer hover:opacity-80">
          ...
          <button
            ...
            className={`w-full h-[56px] md:h-[68px] lg:h-[83px] rounded-full mt-4 md:mt-6 lg:mt-8 flex items-center justify-center relative transition-all group ${
              formStatus.type === 'loading' ? 'bg-gray-500 cursor-not-allowed' : 'bg-white hover:shadow-lg'
            }`}
          >
