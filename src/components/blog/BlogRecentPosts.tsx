                  ...
                  <>
                    ...
                    {post.tag === 'E-commerce' && (
                      <div className="w-full h-full bg-gradient-to-br from-orange-400 to-yellow-500 flex items-center justify-center">
                        <svg className="w-16 md:w-20 h-16 md:h-20 text-white" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {!['ERP', 'Innovation', 'HR', 'E-commerce'].includes(post.tag) && (
                      <div className="w-full h-full bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center">
                        <div className="text-white text-xl md:text-2xl font-bold font-sequel">{post.tag}</div>
                      </div>
                    )}
                  </>
                )}
