    ...
    <div className="relative">
      ...
      <article
        className={cn(
          ...
          isHovered && 'rounded-t-3xl rounded-br-3xl rounded-bl-[160px] bg-[#608BF3] transform -translate-y-1',
        )}
      ...
      >
        ...
        <div className="pt-10 pb-2 h-full flex flex-col justify-between relative z-10">
          <div className="px-5">
            ...
            <p className="text-[10px] sm:text-[12px] leading-[13px] sm:leading-[14px] font-normal text-white/90 font-sequel pt-1.5">{desc}</p>
          </div>
