    ...
    <section className="py-20 bg-white">
      <div className="container-wrapper">
        <div className="text-center mb-16">
          <p className="text-cyan-600 font-medium mb-3">How we work</p>
              ...
              return (
                ...
                >
                  ...
                  <div className={`flex-1 ${isEven ? "md:text-right" : "md:text-left"}`}>
                    <div
                      className={`inline-block bg-gray-100 rounded-2xl p-6 border border-gray-200 ${
                  ...
                  {/* Icon node */}
                  <div className="relative z-10 w-14 h-14 rounded-full bg-black flex items-center justify-center shrink-0">
                    <Icon className="w-6 h-6 text-white" />
                    <span className="absolute -bottom-6 text-xs text-black/40 font-medium">
